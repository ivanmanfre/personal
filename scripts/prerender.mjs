  ...
  for (const route of ROUTES) {
    ...
    try {
      ...
      if (route.startsWith('/scan/')) {
        await page
          .waitForFunction(() => (/^(A content system|An inbound engine|An inbound service|A growth scan|LinkedIn as a revenue line) for /.test(document.title) || /, your LinkedIn plan for qualified calls$/.test(document.title)), { timeout: 15000 })
