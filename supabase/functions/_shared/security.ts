...
const TELL_OPENERS_RX =
  /^(Great|Awesome|Got it|Perfect|Excellent|Wonderful|Fantastic|Absolutely|Certainly|Of course|Sure|Sounds good|Good start|Good to have you|Good to (hear|know|see)|Glad to have you|Glad to (hear|know|see)|Thanks for (jumping|joining|sharing|that)|Thank you for|Nice|Cool|Love (this|that|it))[!.,]?\s+/gim;
