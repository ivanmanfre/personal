-- Follow-up to 20260611_notification_bell.sql.
-- Source #7 (prospect_reply) used needs_manual_reply, but that flag is polluted:
-- 69/81 flagged prospects were stage='dm_sent' that never replied (only 3 had a
-- reply). The accurate "Replies to handle" signal is stage='replied'. Tighten the
-- filter to `stage='replied' AND needs_manual_reply` (81 -> 11 real items).
