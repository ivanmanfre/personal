...
const TestimonialCard: React.FC<{ review: typeof reviews[0] }> = ({ review }) => (
  <div className="w-[500px] shrink-0 bg-zinc-900 border-2 border-zinc-800 p-8 relative group hover:border-accent hover-lift transition-all duration-300 hover:shadow-[8px_8px_0px_0px_rgba(0,230,118,0.15)] flex flex-col h-full">
    ...
    <section className="py-20 bg-black border-y-4 border-black overflow-hidden relative z-20 flex flex-col gap-8">
      ...
      <div className="container mx-auto px-6 relative z-40 flex justify-center mb-4">
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-900 border-2 border-zinc-700 text-white font-mono text-xs uppercase tracking-widest shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:border-accent transition-colors"
        >
