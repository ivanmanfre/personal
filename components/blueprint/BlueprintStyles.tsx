...
// Single source of truth for Blueprint visual system. Imported by:
// - components/dashboard/BlueprintEditor.tsx (the contentEditable surface)
// - components/PublishedBlueprint.tsx (the public buyer-facing read-only surface)
// Editorial Comic-Grid: warm paper bg, sage as punctuation, DM Serif italic for accents,
// IBM Plex Mono for eyebrows, sharp corners, staggered fadeUp animations on first paint.
const BlueprintStyles: React.FC = () => (
  <style>{`
