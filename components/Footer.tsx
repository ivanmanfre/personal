...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-black text-white border-t border-zinc-800 pt-16 pb-8 relative z-10">
      <div className="container mx-auto px-6">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-gray-400 font-bold uppercase tracking-widest">
