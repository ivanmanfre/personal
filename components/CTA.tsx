       ...
       <div className="container mx-auto px-6 text-center relative z-10">
            ...
            >
                <h2 className="text-4xl md:text-6xl font-black uppercase mb-6 leading-[0.9]">
                    Let's Architect The System That <br/> <span className="text-outline text-transparent bg-clip-text bg-black">Replaces Manual Work Forever</span>
                </h2>
                <p className="text-xl font-bold mb-10 max-w-lg mx-auto">
                    Let's find the $100k+ your business is losing to operational drag and turn it into profit.
                </p>
