  ...
  return (
    <section className="tab" data-surface="week">
      ...
      <div style={{ marginTop: 28 }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: isToday ? '2px solid var(--cb-accent)'
                    : d === selectedDay ? '2px solid var(--cb-ink)'
        ...
        <Footnote>
          <Num size="row" inline>{daysWithPost}</Num> of the <Num size="row" inline>{workingDays}</Num> working days in this window carry a post. Weekends are not posting days.
        </Footnote>
      </div>
