    ...
    return (
        <section id="about" className="py-32 bg-black border-y-4 border-black relative overflow-hidden">
            <div className="container mx-auto px-6 relative z-10 max-w-6xl">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-900 border-2 border-zinc-700 text-white font-mono text-xs tracking-widest shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
                ...
                >
                    ...
                    <div className="shrink-0 relative group hover-lift">
                        ...
                        <img
                            ...
                            alt="Iván Manfredi"
                            className="relative z-10 w-48 h-48 md:w-56 md:h-56 object-cover border-3 border-black transition-all duration-500"
                        />
                    </div>
                ...
                >
                    <div className="bg-zinc-900 border-3 border-zinc-800 p-8 md:p-12 shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] relative group hover-lift transition-all">
