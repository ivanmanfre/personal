                  ...
                  return (
                    <div key={a.id} className="px-4 py-3 flex items-start gap-3 hover:bg-zinc-800/20 transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[11px] text-zinc-600 mt-1">{timeAgo(a.createdAt)} · {a.sent ? 'Sent' : 'Unsent'}</p>
                      </div>
                    </div>
                  );
                })}
          ...
          <div className="bg-zinc-900/80 border border-zinc-800/80 rounded-xl overflow-hidden">
            ...
            <div className="divide-y divide-zinc-800/50">
              {reminders.length === 0 ? (
                ...
                reminders.map((r) => (
                  <div key={r.id} className="px-4 py-3 hover:bg-zinc-800/20 transition-colors">
