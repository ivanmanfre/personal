...
const TYPE_TINT: Record<string, string> = {
  ...
  single_image: 'text-sky-700 bg-sky-50',
  carousel:     'text-violet-700 bg-violet-50',
};
    ...
    >
      ...
      >
        <div className="flex items-center gap-2 px-4 py-2.5 border-b border-zinc-800/60 bg-zinc-900/40">
          <span className="text-[13px] text-zinc-300 truncate flex-1 font-medium">{row.title}</span>
          <button
            onClick={onClose}
