...
const SettingsPanel: React.FC = () => {
  const { refreshRate, setRefreshRate, userTimezone, userTimezoneOffset } = useDashboard();
      ...
      <div className="panel-surface shadow-sm shadow-black/10 overflow-hidden">
        ...
        <div className="px-4 py-4">
          <p className="text-sm text-zinc-300">
            {userTimezone} <span className="text-zinc-500">(UTC{userTimezoneOffset >= 0 ? '+' : ''}{userTimezoneOffset})</span>
          </p>
          <p className="text-[11px] text-zinc-500 mt-1">
            Detected automatically from this device — all dashboard times follow your current location. Posts are still scheduled against Buenos Aires audience windows.
          </p>
        </div>
      </div>
