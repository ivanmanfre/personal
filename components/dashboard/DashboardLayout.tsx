...
import { BarChart3, Users, Settings, LayoutDashboard, LogOut, Menu, X, Activity, Swords, Bot, Server, CheckSquare, Calendar, Briefcase, Heart, Target, Video, FlaskConical, Phone, Terminal, Film, Search, Award, Eye, Gauge, Map, Mail, Brain, FileText, Layers, Magnet } from 'lucide-react';
...
const tabGroups: { label: string | null; tabs: { id: Tab; label: string; icon: React.ReactNode }[] }[] = [
  {
    ...
    tabs: [
      ...
      { id: 'strategy', label: 'Strategy', icon: <Map className="w-[18px] h-[18px]" /> },
    ],
  },
  {
    label: 'Content',
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: 'brain', label: 'Brain', icon: <Brain className="w-[18px] h-[18px]" /> },
      { id: 'prompts', label: 'Prompts', icon: <FileText className="w-[18px] h-[18px]" /> },
      { id: 'code', label: 'Code', icon: <Terminal className="w-[18px] h-[18px]" /> },
      { id: 'usage', label: 'Usage', icon: <Gauge className="w-[18px] h-[18px]" /> },
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: 'agent-ready', label: 'Agent-Ready', icon: <Award className="w-[18px] h-[18px]" /> },
    ],
  },
  {
    label: 'Personal',
