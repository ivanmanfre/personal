import { Workflow, Zap, Rocket, FileSignature, Compass } from 'lucide-react';
import { Product } from '../types';

export const products: Product[] = [
  {
    slug: 'ai-orientation-session',
    unlisted: true,
    name: 'AI Orientation Session',
    headline: 'Find where to {{italic:start}} with AI in your business.',
    description:
      'For founders and operators who already run real systems and want to put AI to work without burning months on where to begin. One 90-minute call to map your setup, then a written plan you can act on the same week.',
    category: 'service',
    icon: Compass,
    features: [
      'How to set up Claude Code for the way you actually work',
      'Which MCP servers and skills are worth setting up for your stack',
      'Where AI is worth pointing at in your business',
      'What to automate first for the biggest payback',
      'A concrete learning path, in the order to tackle it',
      'An honest build-versus-outsource call on each piece',
    ...
    setup: [
      ...
      'You want to own the build and run it yourself',
      'You have a specific use case in mind, something concrete you want working',
    ],
    tiers: [
      {
  ...
  },
  {
    ...
    tiers: [
      ...
      },
      {
        ...
        checkoutUrl: 'https://calendly.com/im-ivanmanfredi/30min',
      },
    ],
  },
  {
